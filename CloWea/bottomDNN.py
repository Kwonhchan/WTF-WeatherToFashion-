...
def load_and_preprocess_data(json_file_path):
    ...
    clothing_type = data['metadata.clothes']['clothing_type']
...
def k_fold_training(df, n_splits=5):
    X, y_clothing_type, scaler, clothing_type_encoder = preprocess_data(df)
...
if __name__ == '__main__':
    ...
    save_dataframe_to_csv(df, 'dataset.csv')
